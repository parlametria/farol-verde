...
def create_candidates_index_page(apps, schema_editor):
    ...
    candidate_index_page = CandidateIndexPage(title="Candidatos", slug="candidatos")
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=wagtail.core.fields.StreamField(
                [
                    ("twitter", wagtail.core.blocks.URLBlock(max_length=255)),
                    ("facebook", wagtail.core.blocks.URLBlock(max_length=255)),
                    ("instagram", wagtail.core.blocks.URLBlock(max_length=255)),
                    ("youtube", wagtail.core.blocks.URLBlock(max_length=255)),
                ],
                blank=True,
                null=True,
            ),
