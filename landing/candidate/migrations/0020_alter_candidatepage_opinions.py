# Generated by Django 3.2.12 on 2022-08-15 12:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("candidate", "0019_candidatepage_tse_image_code"),
    ]
                            ...
                            [
                                ...
                                (
                                    ...
                                    wagtail.core.blocks.ChoiceBlock(
                                        ...
                                        defult=True,
                                        label='Opinião do candidato em relação à frase "Sou favorável à retomada dos processos de demarcação de Terras Indígenas e de titulação de Territórios Quilombolas no Brasil, pois concordo que os povos e comunidades tradicionais, indígenas e quilombolas, e suas culturas, contribuem para o enfrentamento da mudança climática, para a conservação dessas Áreas Protegidas e da sociobiodiversidade brasileira.."',
                                    ),
                                ),
                                (
                                    "reforma_tributaria",
