...
from candidate.views.perfil_parlamentar import (
    votacoes_perfil_parlamentar_view,
    social_media_view,
    keywords_view,
    keywords_sections_view,
    propositions_view,
)
from candidate.views.parlamentar import (
    adesao_parlamentar_view,
    proposicoes_onde_parlamentar_e_autor_view,
)
...
urlpatterns = [
    ...
    path(
        "<slug:slug>/api/social-media/<slug:social_app>/<str:keyword>/<str:page>",
        social_media_view,
    ),
